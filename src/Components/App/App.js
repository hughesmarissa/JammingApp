...
import Spotidy from '../../util/Spotify';
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      playlistTracks: [
        ...
        {name: 'playlistName4', artist: 'playlistArtist4', album: 'playlistAlbum4', id: 7 
        },{name: 'playlistName5', artist: 'playlistArtist5', album: 'playlistAlbum5', id: 8 
        }
      ]
    };
